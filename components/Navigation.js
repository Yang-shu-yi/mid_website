    ...
    return (
        ...
        >
            <div className="flex items-center gap-2 group cursor-pointer" onClick={goHome}>
                <span className="text-2xl md:text-3xl group-hover:rotate-180 transition-transform duration-700">🚀</span>
                <span className="font-display font-bold text-base md:text-xl tracking-widest text-white group-hover:text-space-accent transition-colors">
                    BACK TO HOME
                </span>
            </div>
        </motionNav.nav>
