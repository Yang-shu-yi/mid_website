const PLANETS = [
    ...
    },
    {
        id: 'venus',
        name: 'VENUS',
        description: "Second planet from the Sun. It's the hottest planet in our solar system.",
    ...
    },
    {
        id: 'earth',
        name: 'EARTH',
        description: "Our home. The only place we know of so far that's inhabited by living things.",
    ...
    },
    {
        id: 'jupiter',
        name: 'JUPITER',
        description: "Fifth in line from the Sun, Jupiter is, by far, the largest planet in the solar system.",
    ...
    },
    {
        id: 'uranus',
        name: 'URANUS',
        description: "The seventh planet from the Sun, Uranus rotates at a nearly 90-degree angle from the plane of its orbit.",
